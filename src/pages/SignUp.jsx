                    ...
                    <div className='bg-[#FFFFFF] border border-[#D9D8DD] drop-shadow-md rounded-2xl w-full pt-[25px]  pb-[50px] '>
                        ...
                        <form action="" className='flex gap-6 px-4 flex-col mt-2'>
                            <div className='flex flex-col items-start text-left justify-start gap-2'>
                                ...
                                <input type="text" id='name' name='name' placeholder='What is your name?' className='py-[11px] px-3 rounded-lg border border-[#D9D8DD] placeholder:text-[hsl(0,0%,69%)] placeholder:font-medium w-full outline-[#AFAFAF]' value={formData.name} onChange={handleData} />
                            </div>
                            <div className='flex flex-col items-start text-left justify-start gap-2'>
                            ...
                            <div className='flex flex-col items-center w-full gap-4'>
                                <button className='w-full py-4 rounded-lg flex items-center gap-2 justify-center text-[#FFFFFF] font-[500] leading-[18px] bg-[#6172F3]'> Sign up</button>
